...
// ===== VIP SEVİYELERİ =====
const VIP_LEVELS = [
  { level: 0, name: 'Standart',  xpBonus: 0,   perks: [] },
  { level: 1, name: 'VIP I',     xpBonus: 10,  cost: 200, perks: ['%10 XP bonus', 'Mavi çerçeve'] },
  { level: 2, name: 'VIP II',    xpBonus: 20,  cost: 500, perks: ['%20 XP bonus', 'Yeşil çerçeve', 'Özel başlangıç efekti'] },
  { level: 3, name: 'VIP III',   xpBonus: 30,  cost: 1000, perks: ['%30 XP bonus', 'Mor çerçeve', 'Ateş efekti ücretsiz'] },
  { level: 4, name: 'VIP IV',    xpBonus: 40,  cost: 2000, perks: ['%40 XP bonus', 'Kırmızı çerçeve', 'Tüm efektler'] },
  { level: 5, name: 'VIP V',     xpBonus: 50,  cost: 5000, perks: ['%50 XP bonus', 'Altın çerçeve', 'Özel rozet'] },
];
