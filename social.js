...
import {
  ...
  orderBy, limit, getDocs, deleteDoc, arrayUnion,
...
window._fb = {
  ...
  increment, arrayUnion, serverTimestamp, collection, query,
  orderBy, limit, getDocs, addDoc, where
};
...
// Sosyal buton
const btnSoc = document.getElementById('btnSocial');
if (btnSoc) btnSoc.onclick = () => {
